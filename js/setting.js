...
OpenSpending.Styles.Cofog = {
  ...
  '1-1': { icon: 'icons/government-uks.svg', color: '#C75746', bcolor: '#935B3B' },
  '2': { icon: 'icons/government.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-2': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-3': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-4': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-5': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-6': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '2-7': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
   '3': { icon: 'icons/misc-services.svg', color: '#C75746', bcolor: '#4E6D00' },
  ...
  '6': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#EC2406' },
