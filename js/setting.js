...
OpenSpending.Styles.Cofog = {
  ...
  '101': { icon: 'icons/government-uks.svg', color: '#C75746', bcolor: '#935B3B' },
  '2': { icon: 'icons/government.svg', color: '#C75746', bcolor: '#935B3B' },
  '102': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '103': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '104': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '105': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
  '106': { icon: 'ekonomija.svg', color: '#C75746', bcolor: '#0AB971' },
  '107': { icon: 'icons/vote.svg', color: '#C75746', bcolor: '#0AB971' },
